        ...
        public void Configure(ICatalogueScannerHostBuilder builder)
        {
            ...
            builder.Services
                .AddHttpClient<SaleFinderService>(client =>
                {
                    ...
                    client.DefaultRequestHeaders.UserAgent.Add(ProductInfoHeaderValue.Parse("Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/96.0.4664.110 Safari/537.36"));
                })
